...
<html>
    ...
    <body>
        ...
        <div id="show-reference" class="content scaffold-show" role="main">
            ...
            <f:display bean="reference" />
            <g:form resource="${this.reference}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.reference}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
